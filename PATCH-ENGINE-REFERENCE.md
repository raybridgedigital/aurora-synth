...
Reference (the 55 originals, early RMS): median about −34 dBFS, range −51.5 to −18 dBFS
(33 dB spread). **Target for new patches: −30 ± 2 dBFS early RMS** (set with Master). Non-bass patches: share below 120 Hz ≤ about
