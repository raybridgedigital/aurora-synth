...
xcrun clang++ -std=c++20 -O2 -fobjc-arc -I Sources Tests/PluginCoreChecks.mm Sources/PluginCore.mm Sources/SynthEngine.cpp Sources/FmEngine.cpp -framework Foundation -o build/PluginCoreChecks
build/PluginCoreChecks
xcrun clang++ -std=c++20 -O2 -fobjc-arc -I Sources Tests/ReferenceLevels.mm Sources/PluginCore.mm Sources/SynthEngine.cpp Sources/FmEngine.cpp -framework Foundation -o build/ReferenceLevels
build/ReferenceLevels
