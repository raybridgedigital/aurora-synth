...
xcrun clang++ -std=c++20 -O2 -fobjc-arc -I Sources Tests/ReferenceLevels.mm Sources/PluginCore.mm Sources/SynthEngine.cpp -framework Foundation -o build/ReferenceLevels
