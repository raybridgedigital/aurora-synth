...
double tail(int source,float delay,float reverb){SynthEngine e;setup(e);e.setLayerSends(0,0,0);e.setLayerSends(1,delay,reverb);e.prepare(48000);e.midi(source,0x90,60,100);render(e,6000);e.midi(source,0x80,60,0);render(e,2400);return render(e,48000);}
int main(){
