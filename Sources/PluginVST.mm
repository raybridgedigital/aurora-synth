...
DEF_CLASS2(INLINE_UID_FROM_FUID(auroraPlugin::processorUID),PClassInfo::kManyInstances,kVstAudioEffectClass,"Aurora",0,"Instrument|Synth","0.23.1",kVstVersionString,auroraPlugin::Processor::createInstance)
END_FACTORY
