...
| `archive/tests/SpectrumAudit.mm` | **ARCHIVED** | Retired with its bank (25 Sep 2026) | Audited the Spectrum/reference banks, which are archived in `archive/factory-banks`; `Tests/V1FactoryAudioAudit.mm` and `Tests/PluginCoreChecks.mm` cover the shipped AuroraFX bank |
| `archive/tests/ReferenceLevels.mm` | **ARCHIVED** | Retired with its bank (25 Sep 2026) | Audited the Spectrum/reference banks, which are archived in `archive/factory-banks`; `Tests/V1FactoryAudioAudit.mm` and `Tests/PluginCoreChecks.mm` cover the shipped AuroraFX bank |
